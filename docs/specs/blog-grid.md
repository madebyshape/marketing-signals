...
4. Culture page at 1024, viewport, the Block at rest: two columns of cards each 472 wide, the heading at 7xl in six columns, the text in columns nine to twelve. Proves the `lg` step.
